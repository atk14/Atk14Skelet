...
class TcApplication extends TcBase{
	...
	function test__get_return_uri(){
		...
		$this->assertEquals("/en/articles/",$ctrl->_get_return_uri("articles/index"));
		$this->assertEquals("/en/articles/?offset=20",$ctrl->_get_return_uri(["action" => "articles/index", "offset" => 20]));
