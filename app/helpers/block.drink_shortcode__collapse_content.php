<?php
/**
 * Shortcode for hidden content in Bootstrap Collapse component
 * 
 * Usage:
 *
...
function smarty_block_drink_shortcode__collapse_content($params,$content,$template,&$repeat){
	if($repeat){ return; }
	...
	return $template->fetch("shared/helpers/drink_shortcodes/_collapse_content.tpl");
}
