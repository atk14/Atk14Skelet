...
{if $images}
	...
	<section class="section--slider">
		...
		<div class="swiper-container swiper--images gallery__images swiper--images--dark" data-slides_per_view="{$slides_per_view|default: 1}" data-loop="{$loop|default: true}" data-autoplay="false" data-slider_id="{$uniqid}" id="swiper_{$uniqid}"{if $breakpoint} data-breakpoint="{$breakpoint}"{/if}{if $centered_slides} data-centered_slides="{$centered_slides}"{/if}>
		...
		<div class="swiper-container swiper--images swiper--images--dark" data-slides_per_view="auto" data-loop="{$loop|default: true}" data-autoplay="false" data-slider_id="t_{$uniqid}" id="swiper_t_{$uniqid}"{if $breakpoint} data-breakpoint="{$breakpoint}"{/if}{if $centered_slides} data-centered_slides="{$centered_slides}"{/if} data-centered_slides="true" data-thumbsfor="#swiper_{$uniqid}">
			<div class="swiper-wrapper">
