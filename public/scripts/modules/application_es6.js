if( document.querySelector( ".gallery__images, .iobject--picture" ||  document.querySelector( ".js_gallery_trigger" )) ) {
  ...
  try {
    ...
    console.log( "Modul byl úspěšně načten:", PhotoSwipeLightbox );
    ...
    console.log( "Lightbox byl úspěšně inicializován:", lightbox );
  ...
  pictureTriggers.forEach( function( el ) {
    ...
    console.error( "Došlo k chybě při načítání modulu:", error);
  }
} else {
  console.info( "Na stránce nejsou žádné galerie nebo obrázky, které by bylo možné zobrazit v lightboxu." );
}